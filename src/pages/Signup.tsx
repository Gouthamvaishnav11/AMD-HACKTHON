    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative">
      ...
      <div className="relative w-full max-w-md z-10">
        <div className="text-center mb-8 animate-slide-up">
          ...
          <p className="text-muted-foreground mt-1">Start your personalized AI experience</p>
        </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" placeholder="Your name" className="pl-10 bg-muted/50 border-border/50 focus:border-primary/50" value={name} onChange={(e) => setName(e.target.value)} required />
              </div>
            </div>
            <div className="space-y-2">
